...
DB_PATH = r"e:\NG-Billing Software\.dart_tool\sqflite_common_ffi\databases\nextgen_billing.db" # Correct Windows path for sqflite_ffi

# Ensure DB path exists or fallback to home dir
if not os.path.exists(DB_PATH):
    import pathlib
    home = pathlib.Path.home()
    alt_db = home / "Documents" / "nextgen_billing.db"
    if alt_db.exists():
         DB_PATH = str(alt_db)
